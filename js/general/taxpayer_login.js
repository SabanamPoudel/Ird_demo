...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (loginBtn) {
        loginBtn.addEventListener('click', function(e) {
            ...
            // Save PAN number and username to sessionStorage for current session
            sessionStorage.setItem('taxpayerPAN', panNumber);
            sessionStorage.setItem('taxpayerUsername', username);
