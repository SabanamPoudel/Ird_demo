$(document).ready(function() {
    ...
    // Note: Excise form doesn't need registration data display
    // Form is ready to use directly
    
    // No special initialization needed for Excise form
});
...
function loadRegistrationData() {
    ...
    if (registrationData.pan) {
        ...
        // Set default values for demo/training purposes
        $('#displayPan').text('610015263');
        $('#displayBusinessName').text('खाता विजनेश एकेडेमी प्रा.लि.');
        $('#displayAddress').text('Kathmandu');
        $('#displayMobile').text('9841234567');
        $('#displayEmail').text('demo@example.com');
